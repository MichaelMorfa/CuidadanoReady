...
// Note: ICON_MOON_SVG / ICON_SUN_SVG (dark-mode toggle icons) already exist
// in app.js and are unused here -- not redeclared for the same
// duplicate-top-level-const reason as ICON_CHAT_SVG above.
...
// Note: a chat-bubble icon (ICON_CHAT_SVG) already exists in app.js for the
// FAQ bubble; not redeclared here since app.js and member.js load together
// on every member page and a duplicate top-level const throws a SyntaxError
// that silently kills the whole page (this broke the dashboard once already).
